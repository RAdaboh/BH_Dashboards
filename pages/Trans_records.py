...
@st.cache_data
def load_data():
    transactions_df = pd.read_csv('https://drive.google.com/uc?export=download&id=1qfvEooRGvqJQyGxRWT7QjhnSRf9gT2Oc')
    customer_df = pd.read_csv('https://drive.google.com/uc?export=download&id=1T6vNJOlk43to_uWtgva4dAEb6hSncVZc')
